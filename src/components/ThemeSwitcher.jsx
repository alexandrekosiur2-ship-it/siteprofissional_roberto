...
const ThemeSwitcher = () => {
  ...
  return (
    <div className="relative inline-flex items-center">
      {/* Botão Rápido de Toggle (☀️ / 🌙): Alterna entre Dark Steel Safety (Escuro) e Steel & Concrete (Claro) */}
      <button
        onClick={toggleMode}
        ...
        title={isDarkMode ? "Alternar para Modo Claro (Steel & Concrete)" : "Alternar para Modo Escuro (Dark Steel Safety)"}
