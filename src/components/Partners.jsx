...
const Partners = () => {
  ...
  return (
    <section className="py-16 bg-bg-alt relative border-b border-border transition-colors duration-400">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 items-center">
          {partners.map((partner, index) => (
            <motion.div
              ...
              className="p-4 rounded-xl bg-surface border border-border shadow-sm flex flex-col items-center justify-center text-center group hover:border-accent/40 transition-all duration-300"
            >
